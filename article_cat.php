...
if (!$smarty->is_cached('article_cat.dwt', $cache_id))
{
    ...
    /* Meta */
    $meta = $db->getRow("SELECT keywords, cat_desc, cat_title FROM " . $ecs->table('article_cat') . " WHERE cat_id = '$cat_id'");
	...
	$smarty->assign('page_title', $meta['cat_title'] ? $meta['cat_title'] : $position['title']);
