...
if (!$smarty->is_cached('index.dwt', $cache_id))
{
    ...
    $smarty->assign('new_goods',       array_chunk($new_goods, 2));     // 最新商品nre

    //$smarty->assign('hot_goods',       get_recommend_goods('hot'));     // 热点文章
    $promotion_goods = get_promote_goods();
    $smarty->assign('promotion_goods', array_chunk($promotion_goods, 2)); // 特价商品
