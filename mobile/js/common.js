...
function addToCart_quick(goodsId, parentId)
{
  ...
  Ajax.call('flow.php?step=add_to_cart', 'goods=' + objToJSONString(goods), addToCartResponse_quick, 'POST', 'JSON');
...
function getSelectedAttributes(formBuy)
{
  ...
  {
  //  console.log(formBuy.elements[i].name+'---'+formBuy.elements[i].type+'--'+formBuy.elements[i].value)
