<style>
.pagenav{width: 100%;overflow:hidden;line-height:27px;text-align:center;padding-bottom: 100px;}
.pagenav >div{width: 50%;}
.pagenav a{display:inline-block;padding:5px 20px;background-color:#333;color:#fff;}
.pagenav a.no{background-color:#ddd;}
</style>
