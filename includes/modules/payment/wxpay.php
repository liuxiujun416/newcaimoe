...
include_once (ROOT_PATH . "includes/modules/payment/wxpay/WxPay.pub.config.php"); //支付信息配置文件。
include_once (ROOT_PATH . "includes/modules/payment/wxpay/WxPayPubHelper.php");
//echo ROOT_PATH . "includes/modules/payment/wxpay/WxPayPubHelper.php";die;
/**
 * 类
 */
class wxpay {
	...
	function get_code($order, $payment) 
	{
		...
		else 
		{
			...
			return '<img alt="模式一扫码支付" src="http://paysdk.weixin.qq.com/example/qrcode.php?data='.urlencode($url).'" style="width:150px;height:150px;"/>';
