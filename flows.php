...
elseif ($_REQUEST['step'] == 'checkout')
{
    ...
    $smarty->assign('total_amount', price_format($total['amount']));
...
elseif ($_REQUEST['step'] == 'done')
{
    ...
    $finistime = date('Y-m-d H:i:s',strtotime("+24 hours"));
    $smarty->assign('finistime', $finistime);
    //var_dump($finistime);
    /* 订单信息 */
    $smarty->assign('order',      $order);
    $smarty->assign('total',      $total);
...
elseif ($_REQUEST['step'] == 'update_cart')
{
	...
	ecs_header("Location: flows.php?step=checkout\n");
    exit;
}
