...
$top_goods = get_index_topsale();
$top_goods = array_chunk($top_goods, 4);
$smarty->assign('top_goods', $top_goods);           // 销售排行

$new_goods = get_least_goods();
$new_goods = array_chunk($new_goods, 4);
$smarty->assign('new_goods', $new_goods);     		// 最新商品

$smarty->assign('best_goods', get_best_goods());     		// 首页精品商品
